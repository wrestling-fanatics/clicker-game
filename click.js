...
document.getElementById("dont").addEventListener("click", function () {
  if (points >= dont_cost) {
    points -= dont_cost
    updatePoints()
    pointsPerClick += 
  }
})

document.getElementById("dontdo").addEventListener("click", function () {
  if (points >= dontdo_cost) {
    points -= dontdo_cost
    updatePoints()
    pointsPerSecond += 10000000000
  }
})
